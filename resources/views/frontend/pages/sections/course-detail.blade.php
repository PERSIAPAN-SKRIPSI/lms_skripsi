                                ...
                                @if ($course->teacher)
                                    <li>
                                        <span><img class="img-fluid"
                                                src="{{ asset('frontend/assets/images/user_icon_blue.png') }}"
                                                alt="user"></span>
                        ...
                        <div class="wsus__courses_sidebar_video">
                            ...
                            @if (count($chapterDemoVideos) > 0)
                                <a class="play_btn venobox vbox-item" data-autoplay="true" data-vbtype="video"
                                    ...
                                    <img class="img-fluid"
                                        src="{{ asset('frontend/assets/images/play_icon_white.png') }}" alt="Play">
                                </a>
                            @else
                            ...
                            <div class="demo-videos-list mt-3">
                                ...
                                <ul>
                                    @foreach ($chapterDemoVideos as $index => $demoVideo)
                                        <li>
                                            <a class="venobox vbox-item" data-vbtype="video"
                                                href="{{ $demoVideo['video_url'] }}">
                        ...
                        <div class="wsus__courses_sidebar_list_info">
                            ...
                            <div class="enroll-section">
                                ...
                                @elseif(!$courseEmployee)
                                    <form action="{{ route('employees-dashboard.courses.enroll', $course->slug) }}"
                                        method="POST">
                                        @csrf
                                ...
                                @else
                                    <a class="common_btn"
                                        href="{{ route('employees-dashboard.courses.learn', $course->slug) }}">Mulai
                                        Belajar <i class="far fa-arrow-right"></i></a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="wsus__courses_sidebar_instructor">
                            ...
                            <ul class="d-flex flex-wrap">
                                ...
                                <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Top Earning"><img
                                        class="img-fluid"
                                        src="{{ asset('frontend/assets/images/badge_5.png') }}"alt="Badge"></li>
                                <li data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Trending"><img
                                        class="img-fluid" src="{{ asset('frontend/assets/images/badge_3.png') }}"
                                        alt="Badge">
                                </li>
                            </ul>
                        </div>
