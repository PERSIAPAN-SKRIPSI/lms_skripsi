<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.courses.show', $course) }}" class="text-gray-500 hover:text-gray-700">
                  ...
                  <form method="POST" action="{{ route('admin.courses.store-chapter', $course) }}" class="flex flex-col gap-y-4">
                     ...
                     <div>
                            <x-input-label for="order" :value="__('Order')" />
                             <x-text-input id="order" class="block mt-1 w-full" type="number" name="order" :value="old('order')"  autocomplete="order" />
