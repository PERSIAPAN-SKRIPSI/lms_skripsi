                        ...
                        <div class="space-y-4">
                            @forelse ($course->chapters as $chapter)
                                <div x-data="{ open: false }"
                                    ...
                                    <div class="md:flex md:items-center md:justify-between cursor-pointer"
                                        @click="open = !open">
                                    ...
                                    <div x-show="open" class="mt-4"
                                        ...
                                        <div id="videos-{{ $chapter->id }}" class="tab-content">
                                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                                ...
                                                @empty
                                                    <p class="text-gray-500 col-span-full text-center">No videos in
                                                        this
                                                        chapter yet.</p>
                                                @endforelse
                                            </div>
                                        ...
                                        <div id="quizzes-{{ $chapter->id }}" class="tab-content hidden">
                                            <div class="space-y-4">
                                                            ...
                                                            <div class="flex justify-between items-start">
                                                                <div>
                                                                    ...
                                                                    <div class="mt-1 text-sm text-gray-500">
                                                                        ...
                                                                        <p>Passing Score: {{ $quiz->passing_score }}%
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                ...
                                                @empty
                                                    <p class="text-gray-500 text-center">No quizzes in this chapter
                                                        yet.
                                                    </p>
                                                @endforelse
                                            </div>
