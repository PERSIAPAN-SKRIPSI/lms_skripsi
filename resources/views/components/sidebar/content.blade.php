        ...
        @if (auth()->user()->hasRole('admin'))
            <div>
                ...
                <x-sidebar.dropdown title="Course Management" :isActive="Str::startsWith(request()->route()->getName(), 'admin.courses.') ||
                    ...
                    <x-sidebar.sublink href="{{ route('admin.categories.index') }}" title="Categories"
                        :isActive="request()->routeIs('admin.categories.index')" />
                </x-sidebar.dropdown>
                ...
                <x-sidebar.dropdown title="Quiz Management" :isActive="Str::startsWith(request()->route()->getName(), 'admin.quizzes.')">
                    <x-slot name="icon">
                        <x-heroicon-o-question-mark-circle
                            class="flex-shrink-0 w-5 h-5 text-gray-600 dark:text-gray-400" aria-hidden="true" />
                    </x-slot>
                    <x-sidebar.sublink href="{{ route('admin.quizzes.index') }}" title="All Quizzes"
                        :isActive="request()->routeIs('admin.quizzes.index')" />
                ...
                <x-sidebar.dropdown title="Quiz Monitoring" :isActive="Str::startsWith(request()->route()->getName(), 'admin.quizzes.monitoring.')">
                    ...
                    <x-sidebar.sublink href="{{ route('admin.quizzes.monitoring.performance') }}"
                        title="Quiz Performance" :isActive="request()->routeIs('admin.quizzes.monitoring.performance')" />
...
@if (auth()->user()->hasRole('teacher') && auth()->user()->teacher && auth()->user()->teacher->is_active)
    <div>
        ...
        <x-sidebar.link href="{{ route('teacher.dashboard') }}" title="Dashboard" :isActive="request()->routeIs('teacher.dashboard')">
            <x-slot name="icon">
                <x-icons.dashboard class="flex-shrink-0 w-5 h-5 text-gray-600 dark:text-gray-400"
                    aria-hidden="true" />
            </x-slot>
        ...
        <x-sidebar.dropdown title="Course Management" :isActive="Str::startsWith(request()->route()->getName(), 'teacher.courses.')">
            ...
            <x-sidebar.sublink href="{{ route('teacher.courses.index') }}" title="My Courses"
                :isActive="request()->routeIs('teacher.courses.index')" />
            <x-sidebar.sublink href="{{ route('teacher.categories.index') }}" title="Categories"
                :isActive="request()->routeIs('teacher.categories.index')" />
        </x-sidebar.dropdown>
        ...
        <x-sidebar.dropdown title="Quiz Management" :isActive="Str::startsWith(request()->route()->getName(), 'teacher.quizzes.')">
            ...
            <x-sidebar.sublink href="{{ route('teacher.quizzes.index') }}" title="All Quizzes"
                :isActive="request()->routeIs('teacher.quizzes.index')" />
            <x-sidebar.sublink href="{{ route('teacher.quizzes.create') }}" title="Create Quiz"
                :isActive="request()->routeIs('teacher.quizzes.create')" />
        </x-sidebar.dropdown>

        <x-sidebar.dropdown title="Employee Course Management" :isActive="Str::startsWith(request()->route()->getName(), 'teacher.employee-courses.')">
            <x-slot name="icon">
                <x-heroicon-o-briefcase class="flex-shrink-0 w-5 h-5 text-gray-600 dark:text-gray-400"
                    aria-hidden="true" />
            </x-slot>
            <x-sidebar.sublink href="{{ route('teacher.employee-courses.index') }}" title="Employee Courses"
                :isActive="request()->routeIs('teacher.employee-courses.index')" />
            <x-sidebar.sublink href="{{ route('teacher.employee-courses.approve.list') }}"
                title="Approve Courses" :isActive="request()->routeIs('teacher.employee-courses.approve.list')" />
        </x-sidebar.dropdown>
    </div>
    <hr class="border-gray-200 dark:border-gray-700">
@endif
        ...
        @if (auth()->user()->hasRole('employee'))
            <div>
                ...
                <x-sidebar.link href="{{ route('employees-dashboard.dashboard') }}" title="My Resume"
                    :isActive="request()->routeIs('employees-dashboard.dashboard')">
                    <x-slot name="icon">
                        <x-icons.dashboard class="flex-shrink-0 w-5 h-5 text-gray-600 dark:text-gray-400"
                            aria-hidden="true" />
                    </x-slot>
                </x-sidebar.link>
                <x-sidebar.link href="{{ route('employees-dashboard.learning-progress.index') }}"
                    title="Learning Progress" :isActive="request()->routeIs('employees-dashboard.learning-progress.index')">
                    <x-slot name="icon">
                        <x-heroicon-o-chart-bar class="flex-shrink-0 w-5 h-5 text-gray-600 dark:text-gray-400"
