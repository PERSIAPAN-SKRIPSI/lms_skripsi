  ...
  <section class="wsus__courses_3 pt_120 xs_pt_100 mt_120 xs_mt_90 pb_120 xs_pb_100">
      <div class="container">
                  ...
                  <div class="wsus__filter_area mb_15">
                      <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                          ...
                          @foreach ($categories as $category)
                              <li class="nav-item" role="presentation">
                                  <button class="nav-link" id="pills-{{ Str::slug($category->name) }}-tab"
                                      data-bs-toggle="pill" data-bs-target="#pills-{{ Str::slug($category->name) }}"
                                      type="button" role="tab"
                                      aria-controls="pills-{{ Str::slug($category->name) }}"
          ...
          <div class="tab-content" id="pills-tabContent">
                          ...
                          <div class="col-xl-3 col-md-6 col-lg-4">
                              <div class="wsus__single_courses_3">
                                  <div class="wsus__single_courses_3_img">
                                      <img src="{{ Storage::url($course->thumbnail) }}" class="card-img-top rounded-top"
                                  ...
                                  <div class="wsus__single_courses_text_3">
                                      ...
                                      <a class="author" href="#">
                                          <div class="img">
                                              ...
                                              <!-- Menjadi ini: -->
                                              <img src="{{ $course->teacher && $course->teacher->user ? Storage::url($course->teacher->user->avatar) : asset('frontend/assets/images/default-avatar.png ') }}"
              ...
              @foreach ($categories as $category)
                  <div class="tab-pane fade" id="pills-{{ Str::slug($category->name) }}" role="tabpanel"
                      aria-labelledby="pills-{{ Str::slug($category->name) }}-tab" tabindex="0">
                      <div class="row">
      ...
      <div class="row mt_60 wow fadeInUp">
          <div class="col-12 text-center">
              <a class="common_btn" href="{{ route('frontend.pages.courses') }}">Browse More Courses <i
