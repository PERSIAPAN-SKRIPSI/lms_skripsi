                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.questions.update', [$quiz->id, $question->id]) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="question" id="question" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>{{ old('question', $question->question) }}</textarea>
